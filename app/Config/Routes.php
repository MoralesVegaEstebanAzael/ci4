...
$routes->post('/hello', 'Home::helloWorld');
$routes->post('/add', 'Home::add');

$routes->post('/task','TaskController::store');
$routes->get('/task','TaskController::read');
...
$routes->post('/register', 'UserController::register',['filter'=>'noauth']);

$routes->get('logout', 'UserController::logout');
$routes->get('/dashboard','Home::dashboard',['filter'=>'auth']);

/*<!--    var myvar="--><?//=session()->get('name')?><!--//";-->*/
/**
 * --------------------------------------------------------------------
 * Additional Routing
 * --------------------------------------------------------------------
